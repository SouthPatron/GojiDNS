...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NameserverStatus'
        db.create_table('goji_nameserverstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hostname', self.gf('django.db.models.fields.CharField')(unique=True, max_length=253)),
            ('heartbeat', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('goji', ['NameserverStatus'])


    def backwards(self, orm):
        # Deleting model 'NameserverStatus'
        db.delete_table('goji_nameserverstatus')
