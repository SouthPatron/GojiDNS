...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NameserverStatus.resolving_ip6'
        db.delete_column('goji_nameserverstatus', 'resolving_ip6')

        # Deleting field 'NameserverStatus.sql_connection'
        db.delete_column('goji_nameserverstatus', 'sql_connection')

        # Deleting field 'NameserverStatus.resolving_ip4'
        db.delete_column('goji_nameserverstatus', 'resolving_ip4')

        # Deleting field 'NameserverStatus.last_run'
        db.delete_column('goji_nameserverstatus', 'last_run')

        # Adding field 'NameserverStatus.status'
        db.add_column('goji_nameserverstatus', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=99),
                      keep_default=False)

        # Adding field 'NameserverStatus.last_okay'
        db.add_column('goji_nameserverstatus', 'last_okay',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NameserverStatus.resolving_ip6'
        db.add_column('goji_nameserverstatus', 'resolving_ip6',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NameserverStatus.sql_connection'
        db.add_column('goji_nameserverstatus', 'sql_connection',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NameserverStatus.resolving_ip4'
        db.add_column('goji_nameserverstatus', 'resolving_ip4',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NameserverStatus.last_run'
        db.add_column('goji_nameserverstatus', 'last_run',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 14, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'NameserverStatus.status'
        db.delete_column('goji_nameserverstatus', 'status')

        # Deleting field 'NameserverStatus.last_okay'
        db.delete_column('goji_nameserverstatus', 'last_okay')
    ...
    models = {
        ...
        'goji.nameserverstatus': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_okay': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '99'})
        },
        'goji.profile': {
