...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NameserverStatus.first_seen'
        db.add_column('goji_nameserverstatus', 'first_seen',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NameserverStatus.first_seen'
        db.delete_column('goji_nameserverstatus', 'first_seen')
    ...
    models = {
        ...
        'goji.nameserverstatus': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_run': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'resolving_ip4': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'resolving_ip6': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sql_connection': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'goji.profile': {
