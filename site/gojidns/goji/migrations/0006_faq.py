...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Faq'
        db.create_table('goji_faq', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('position', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=253)),
            ('answer', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('goji', ['Faq'])


    def backwards(self, orm):
        # Deleting model 'Faq'
        db.delete_table('goji_faq')
    ...
    models = {
        ...
        'goji.faq': {
            'Meta': {'ordering': "['position', 'question']", 'object_name': 'Faq'},
            'answer': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'question': ('django.db.models.fields.CharField', [], {'max_length': '253'})
        },
        'goji.nameserverstatus': {
            'Meta': {'ordering': "['hostname']", 'object_name': 'NameserverStatus'},
